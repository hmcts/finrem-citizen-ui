...
const config = {
  ...
  systemUser: {
    username: process.env['finrem-system-update-username'] || process.env.IDAM_SYSTEM_USERNAME || '',
    password: process.env['finrem-system-update-password'] || process.env.IDAM_SYSTEM_PASSWORD || '',
  },
