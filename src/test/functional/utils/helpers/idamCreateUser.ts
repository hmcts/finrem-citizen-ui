...
const idamEnv = process.env.IDAM_ENV || inferredPublicEnv;

const IDAM_WEB_URL = stripTrailingSlash(
  process.env.IDAM_WEB_URL || `https://idam-web-public.${idamEnv}.platform.hmcts.net`
);
...
const IDAM_TESTING_SUPPORT_API_URL = stripTrailingSlash(
  process.env.IDAM_TESTING_SUPPORT_API_URL
    ...
    || `https://idam-testing-support-api.${idamEnv}.platform.hmcts.net`
);
