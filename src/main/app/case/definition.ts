...
export interface FinremCaseData extends HasCaseDocument {
  ...
  citizenApplicantDocument: CitizenDocumentCollection[];
  citizenRespondentDocument: CitizenDocumentCollection[];
...
export enum CitizenUploadDocumentType {
    ...
    POTENTIAL_BORROWING_CAPACITY_MORTGAGE_CAPACITIES = "Potential borrowing capacity / mortgage capacities",
    PRE_HEARING_DRAFT_ORDER = "Pre hearing draft order",
    ...
    REPLY_TO_SCHEDULE_OF_DEFICIENCIES_OR_SUPPLEMENTAL_QUESTIONNAIRES = "Reply to schedule of deficiencies or supplemental questionnaires",
    REPLY_TO_SCHEDULE_OF_DEFICIENCIES_OR_SUPPLEMENTAL_QUESTIONNAIRES_SUPPORTING_DOCUMENTS = "Reply to schedule of deficiencies or supplemental questionnaires - supporting documents",
    RESPONSE_TO_THE_NOTICE_OF_FIRST_APPOINTMENT_FORM_G = "Response to the notice of first appointment: Form G",
    ...
    STATEMENT_OF_COSTS_SUMMARY_ASSESSMENT_FORM_N260 = "Statement of costs (summary assessment): Form N260",
    STATEMENT_OF_COSTS_FORM_H1 = "Statement of costs: Form H1",
    STATEMENT_OF_ISSUES = "Statement of issues",
    STATEMENT_OF_POSITION_ON_NON_COURT_DISPUTE_RESOLUTION_NCDR_FORM_FM5 = "Statement of position on non-court dispute resolution (NCDR): Form FM5",
